...
namespace Web.API.Repositories.Setup.Implementations
{
    ...
    {
        private readonly IHREmployeeRepository _employeeService;
        private readonly IJwtRepository _jwtService;
        private readonly IRefreshTokenRepository _refreshTokenService;

        public AuthRepository(IHREmployeeRepository employeeService,IJwtRepository jwtService,IRefreshTokenRepository refreshTokenService)
        {
